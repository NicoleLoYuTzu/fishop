...
class FishSellerFragment() : Fragment() {
    ...
    private val viewModel by viewModels<FishSellerViewModel> {
        getVmFactory()
    }
    ...
    override fun onCreateView(
        ...
        binding.recyclerView.adapter = FishSellerAdapter(
            FishSellerAdapter.OnClickListener {
